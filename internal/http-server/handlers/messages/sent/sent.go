...
//go:generate mockgen -source=$GOFILE -destination=./mocks/mock_sent_usecase.go -package=mocks
...
func New(messageUCase MessageUsecase, avatarUCase AvatarUsecase, SECRET []byte) *HandlerSent {
	return &HandlerSent{
