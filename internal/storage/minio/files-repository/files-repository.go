...
func New(client *minio.Client, bucketName string, publicBaseURL string, publicUseSSL bool) *FilesRepository {
...
func (repo *FilesRepository) UploadFile(ctx context.Context, objectName string, data io.Reader, size int64, contentType string) error {
...
func (repo *FilesRepository) GetFilePresignedURL(ctx context.Context, objectName string, duration time.Duration) (*url.URL, error) {
...
func (repo *FilesRepository) DeleteFile(ctx context.Context, objectName string) error {
