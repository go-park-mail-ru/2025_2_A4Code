...
func FindlastAppealByProfileID(ctx context.Context, profileID int64) (domain.Appeal, error) {
	return uc.repo.FindLastAppealByProfileID(ctx, profileID)(domain.Appeal, error)
}
