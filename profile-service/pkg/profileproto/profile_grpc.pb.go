...
const (
	ProfileService_GetProfile_FullMethodName    = "/profileproto.ProfileService/GetProfile"
	ProfileService_UpdateProfile_FullMethodName = "/profileproto.ProfileService/UpdateProfile"
	ProfileService_Settings_FullMethodName      = "/profileproto.ProfileService/Settings"
	ProfileService_UploadAvatar_FullMethodName  = "/profileproto.ProfileService/UploadAvatar"
)
...
func (c *profileServiceClient) Settings(ctx context.Context, in *SettingsRequest, opts ...grpc.CallOption) (*SettingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProfileService_Settings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProfileService_Settings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProfileService_Settings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
